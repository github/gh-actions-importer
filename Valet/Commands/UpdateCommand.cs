...
public class UpdateCommand : BaseCommand
{
    ...
    private static readonly Option<string> UsernameOption = new Option<string>(new[] { "-u", "--username" })
    {
        Description = "Username to authenticate with GHCR. Can optionally be set with GHCR_USERNAME env variable.",
        IsRequired = false,
    };
    
    private static readonly Option<string> PasswordOption = new Option<string>(new[] { "-p", "--password" })
    {
